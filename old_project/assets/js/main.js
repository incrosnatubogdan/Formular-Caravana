...
function editPopup() {
    var popup = '<div class="overlay accept_edit"><div class="popup"><p>Datele de identificare a pacientului au fost introduse la receptie. Sunteti sigur ca doriti sa modificati aceste date?</p><div class="button_holder edit_btn"><button class="nu">Nu</button><button class="da">Da</butto></div></div></div>';
    $("body").append(popup);
}
